...
int main() {
    vector<Note> notes;
    notes.emplace_back(Year(2023), Month(11), Day(14), Hour(18), Minute(59), "Це перша нотатка.");
    notes.emplace_back(Year(2023), Month(11), Day(15), Hour(12), Minute(30), "Це друга нотатка.");
    for (Note& note : notes) {
        note.display();
        cout << endl;
    }
